...
if (process.env.NODE_ENV == "local") {
  sequelize = new Sequelize("pt-local", "root", "abcd1234", {
    dialect: "sqlite",
...
db.reward_redemption_request = sequelize.import(
  "../models/rewards/reward_redemption_request.js"
);
...
db.wallet_transaction = sequelize.import(
  "../models/user/wallet_transaction.js"
);
db.wallet_transaction.belongsTo(db.user);
db.wallet_transaction.belongsTo(db.article_share, {
  foreignKey: { as: "source" },
});
db.wallet_transaction.belongsTo(db.job_referral, {
  foreignKey: { as: "source" },
});
db.wallet_transaction.belongsTo(db.reward_redemption_request, {
  foreignKey: { as: "source" },
});
